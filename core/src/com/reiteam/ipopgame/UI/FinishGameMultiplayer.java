...
public class FinishGameMultiplayer extends UIScreen{
    private Stage stage;
    ...
    public static FinishGameMultiplayer getInstance(){
        return instance;
    }
    @Override
